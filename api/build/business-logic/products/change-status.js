...
exports.ChangeStatusProduct = void 0;
const constant_definitions_1 = require("../../constant-definitions");
const entities_1 = require("../../entities");
const ChangeStatusProduct = (uuid) => __awaiter(void 0, void 0, void 0, function* () {
    const model = (0, constant_definitions_1.getModel)(constant_definitions_1.Collection.PRODUCTS, entities_1.ProductSchemaMongo);
    const product = yield model.findOne({ _id: uuid });
    if (!product) {
        throw new Error("product not found");
    }
    product.status = entities_1.StatusType.DELETED;
    yield product.save();
    return product;
});
